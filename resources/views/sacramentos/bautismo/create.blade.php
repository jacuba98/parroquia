        ...
        <div class="row">
         ...
         <div class="col-sm-6">
           <div class="form-group">Lugar de nacimiento:
             <input name="lugar" type="text" class="form-control" value="{{ old('lugar')}}" placeholder="Lugar de nacimiento...">
           </div>
         </div>
         ...
         <div class="col-sm-6">
           <div class="form-group">No. Registro civil:
             <input name="rc" type="text" class="form-control" value="{{ old('rc')}}" placeholder="No. Registro civil...">
           </div>
         </div>
