    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('bautismo.index') }}" :active="request()->routeIs('bautismo.index')">
                        {{ __('Bautismos') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('comunion.index') }}" :active="request()->routeIs('comunion.index')">
                        {{ __('Comunion') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('confirmacion.index') }}" :active="request()->routeIs('confirmacion.index')">
                        {{ __('Confirmacion') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('matrimonio.index') }}" :active="request()->routeIs('matrimonio.index')">
                        {{ __('Matrimonio') }}
                    </x-jet-nav-link>
                </div>
